...
theorem zero_mul (a : R) : 0 * a = 0 := by
  nth_rw 1 [← neg_add_cancel a]
  rw [add_mul]
  rw [neg_mul, neg_add_cancel]


theorem neg_eq_of_add_eq_zero {a b : R} (h : a + b = 0) : -a = b := by
  rw [← zero_add (-a)]
  rw [add_comm] at h
  rw [← h, add_assoc, add_neg_cancel (a), add_zero]
...
theorem mul_inv_cancel (a : G) : a * a⁻¹ = 1 := by
  ...
  rw [mul_assoc, mul_assoc (a) (a⁻¹) (a * a⁻¹), ← mul_assoc a⁻¹ a a⁻¹]
